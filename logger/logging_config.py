...
file_handler = RotatingFileHandler(LOG_FILE, maxBytes=10 * 1024 * 1024, backupCount=3) # This rotates the logs when the file size exceeds 10 MB
file_handler.setLevel(logging.DEBUG) # Logs DEBUG level and above to the file
